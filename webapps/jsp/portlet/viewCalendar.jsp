...
<div class="portlet_margin">
	...
	<form name="inputForm" method="POST" action="<c:out value="${updateCalendarActionUrl}"/>">
	    ...
	    <calendar:selectField label="labels.internal.calendar.eventType" name="'languageId'" multiple="false" value="languages" selectedValue="calendar.languages.id" cssClass="listBox"/>
