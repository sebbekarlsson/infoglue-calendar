...
<div class="portlet_margin">
    ...
    <input onclick="document.location.href='<%= java.net.URLDecoder.decode(request.getParameter("okUrl"), "utf-8") %>';" type="submit" value="<ww:property value="this.getLabel('labels.internal.applicationOK')"/>" title="Radera "postens namn""/>
