...
<div class="head"><ww:property value="this.getLabel('labels.internal.event.updateEvent')"/></div>
...
<div class="portlet_margin">
	...
	<form name="updateForm" method="POST" action="<c:out value="${updateEventActionUrl}"/>">
		...
		<span class="errorMessage"><ww:property value="#fieldErrors.lastRegistrationDateTime"/></span>
		<div class="fieldrow">
			<label for="lastRegistrationDateTime"><ww:property value="this.getLabel('labels.internal.event.lastRegistrationDate')"/></label><span class="redstar">*</span><br />
