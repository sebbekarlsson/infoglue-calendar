...
<div class="head"><ww:property value="this.getLabel('labels.internal.eventTypeCategoryAttribute.updateEventTypeCategoryAttribute')"/> <ww:property value="eventType.name"/></div>
