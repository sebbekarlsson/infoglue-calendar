...
import org.infoglue.calendar.controllers.SubscriberController;
...
public class ViewEventSubscriptionListAction extends CalendarAbstractAction
{
    ...
    public String execute() throws Exception 
    {
        ...
        this.subscribers = SubscriberController.getController().getSubscriberList(principal.getEmail(), this.getSession());
